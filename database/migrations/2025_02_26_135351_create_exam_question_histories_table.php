...
return new class extends Migration
{
    ...
    {
        Schema::create('exam_question_histories', function (Blueprint $table) {
            // Primary Key
            ...
            $table->softDeletes();
            $table->string('action', 100)->comment('Action performed on the question history');
            $table->timestamps();
    ...
    {
        Schema::dropIfExists('exam_question_histories');
    }
};