...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('exam_sections', function (Blueprint $table) {
            ...
            // Section Details
            $table->enum('audience', ['High School', 'College', 'Graduation', 'SAT 2'])->nullable()->index();
            $table->enum('section_type', ['Physics', 'Chemistry', 'Biology', 'Math', 'Verbal', 'Quant', 'Mixed'])->nullable()->index();
            ...
            $table->integer('section_order')->default(1)->comment('total section 4')->index();
