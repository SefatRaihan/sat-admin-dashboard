    ...
    i.prototype = {
          ...
          if (
            ...
            s(o.$ed.children(r).first()),
              ...
              o.$ed
                ...
                .filter(function () {
                  return (
                    (!o.range || this !== o.range.startContainer) &&
                    0 === a(this).text().trim().length &&
                    0 === a(this).children().not("br,span").length
                  );
                })
                .contents()
                .unwrap(),
      ...
      createLink: function () {
        ...
        if (i && "A" === i.nodeName) {
          ...
          (s = l.text()),
            (e = l.attr("href")),
            o.o.minimalLinks || ((t = l.attr("title")), (n = l.attr("target")));
        ...
        var c = {
          ...
          text: { label: o.lang.text, value: s },
        };
        o.o.minimalLinks ||
          Object.assign(c, {
          ...
          o.openModalInsert(o.lang.createLink, c, function (e) {
            ...
            return (
              o.o.minimalLinks ||
                (e.title.length > 0 && n.attr("title", e.title),
                e.target.length > 0 && n.attr("target", e.target)),
