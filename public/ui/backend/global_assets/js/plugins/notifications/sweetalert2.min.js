!(function (t, e) {
      ...
      e.container.onmousedown = function () {
        e.popup.onmouseup = function (t) {
          (e.popup.onmouseup = void 0),
            (t.target !== e.popup && !e.popup.contains(t.target)) || (an = !0);
        };
      };
    },
    un = function (n, o, i) {
      ...
      ye.swalPromiseResolve.set(a, t),
        ...
        (s.denyButton.onclick = function () {
          return (
            (e = c),
            (t = a).disableButtons(),
            void (e.returnInputValueOnDeny ? Ke(t, e, "deny") : Ze(t, e, !1))
          );
          var t, e;
        }),
        ...
        (r = s),
        (t = e),
        St.innerParams.get(n).toast ? rn(n, r, t) : (sn(r), cn(r), un(n, r, t)),
        (o = a),
        (r = c),
        (i = e),
        (t = oe).keydownTarget &&
  ...
  var fn = function (t, e, n) {
    ...
    mn = function (t, e) {
      if (!e.toast)
        return Y(e.allowEnterKey) ? void (hn(t, e) || qe(0, -1, 1)) : gn();
    },
    hn = function (t, e) {
  ...
  var bn,
    ...
    Q = Object.freeze({
      ...
      enableInput: function () {
        return Employee(this.getInput(), !1);
      },
      disableInput: function () {
        return Employee(this.getInput(), !0);
      },
