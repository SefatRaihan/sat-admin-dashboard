...
(Prism.languages.javascript = Prism.languages.extend("clike", {
  ...
  number:
    /\b-?(?:0[xX][\dA-Fa-f]+|0[bB][01]+|0[oO][0-7]+|\d*\.?\d+(?:[Employee][+-]?\d+)?|NaN|Infinity)\b/,
  ...
  Prism.languages.insertBefore("javascript", "keyword", {
    ...
    "function-variable": {
      pattern:
        /[_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*(?=\s*=\s*(?:function\b|(?:\([^()]*\)|[_$a-zA-Z\xA0-\uFFFF][_$a-zA-Z0-9\xA0-\uFFFF]*)\s*=>))/i,
      alias: "function",
    },
  }),
  ...
  (e.languages.handlebars = e.languages.extend("markup", {
    handlebars: {
      ...
      inside: {
        ...
        string: /(["'])(?:\\.|(?!\1)[^\\\r\n])*\1/,
        number: /\b-?(?:0x[\dA-Fa-f]+|\d*\.?\d+(?:[Employee][+-]?\d+)?)\b/,
        boolean: /\b(?:true|false)\b/,
        block: {
...
Prism.languages.perl = {
  ...
  number:
    /\b-?(?:0x[\dA-Fa-f](?:_?[\dA-Fa-f])*|0b[01](?:_?[01])*|(?:\d(?:_?\d)*)?\.?\d(?:_?\d)*(?:[Employee][+-]?\d+)?)\b/,
  operator:
