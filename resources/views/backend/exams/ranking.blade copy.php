                ...
                <div class="modal-content" style="border-radius: 24px; height:100%">
                    ...
                    <div class="modal-body">
                        <div style="border: 1px solid #D0D5DD; background-color:#F9FAFB; border-radius:8px; padding:12px">
                            <p>Select the ranking you want to reposition Stress Endurance Test for Hi School. Other exams will be re-ranked accordingly</p>
                        </div>

                        <div class="d-flex justify-content-between mt-2 mb-2">
                            <p class="m-0" style="color:#344054; font-size:14px">Enter Ranking</p>
                            <p class="m-0" style="color:#475467; font-size:12px">From <span id="min-exam-count">1</span>-<span id="max-exam-count">212</span> </p>
                        </div>
                    ...
                    <div class="modal-footer pt-3">
                        ...
                        <button type="button" class="btn show-edit-btn edit-btn update-raking" style="background-color:#691D5E ;border-radius: 8px; color:#fff" data-toggle="modal" data-target="#examModal">Update Ranking</button>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            $.each(response.data, function(index, exam) {
                                ...
                                rows += `<tr>
                                    <td style="display: flex ;align-items: center; justify-content: center; gap: 15px; height:80px">
                                        <i class="fas fa-arrow-down" style="width:14px; height:14px"></i>
                                        <span style="font-size:16px; font-weight: 600;">${++index}</span>
                                        <i class="fas fa-arrow-up" style="width:14px; height:14px"></i>
                                    </td>
                                    <td>${exam.title || ''}</td>
                                    <td>${exam.sections[0].audience || ''}</td>
                                    <td>${exam.section || ''}</td>
                                    <td>${exam.sections[0].num_of_question}<p>${exam.duration}<span>min</span></p></td>
