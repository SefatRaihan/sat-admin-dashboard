<x-backend.layouts.master>
    <div class="page-header-content header-elements-md-inline pl-0 ml-0 pr-0 mr-0">
        ...
        <div class="header-elements d-none">
            ...
            <div class="d-flex justify-content-end">
                ...
                <div class="">
                    <a href="/discounts/create" class="btn create-btn" style="border:1px solid #D0D5DD; padding: 7px .875rem !important; font-size:12px; border-radius:8px;">Referral Settings</a>
                </div>
    ...
    <div class="p-2 pb-0" style="background-color: #F9FAFB">
        <div class="row">
            <div class="col-md-4">
                <div class="card p-2 mb-0">
                    <h2 class="mb-0" style="font-size: 24px; color: #000000">06</h2>
                    <p style="font-size:16px; color: #667085">Total Referees</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card p-2 mb-0">
                    <h2 class="mb-0" style="font-size: 24px; color: #000000">02</h2>
                    <p style="font-size:16px; color: #667085">Total Redemptions</p>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card p-2 mb-0">
                    <h2 class="mb-0" style="font-size: 24px; color: #000000">SAR 250</h2>
                    <p style="font-size:16px; color: #667085">Total Amount Earned</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card-header d-flex justify-content-between">
        <div>
            <input type="text" id="search" class="form-control search_input" style="background-color: #fff" placeholder="Search Referrals" style="padding-left: 40px">
        </div>
                        ...
                        <table class="table table-hover align-middle">
                            <thead>
                                <tr align="center">
                                    ...
                                    <th class="text-left">No. of Times Code Used</th>
                                    <th class="text-left">Total Earnings (SAR)</th>
                                </tr>
                            </thead>
