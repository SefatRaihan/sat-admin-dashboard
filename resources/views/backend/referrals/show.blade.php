<x-backend.layouts.master>
    <div class="border-bottom pt-2 pl-4 pb-2">
        <h4 class="form-header text-left">Referral Details</h4>
        <button class="btn" style="border: 1px solid #ddd; border-radius: 50%; height: 50px; width: 50px; margin-right: 10px;"> <span><i class="fas fa-arrow-left"></i></span></button>Back to Referrals
    </div>
    ...
    <div class="p-3">
        <table class="table table-striped custom-table" style="border: 1px solid #EAECF0">
            <tr>
                ...
                <td style="width: 25%">Redeemer's Name</td>
                <td class="font-weight-bold" style="width: 25%">: </td>
            </tr>

            <tr>
                <td style="width: 25%">No. of Times Code Used</td>
                <td class="font-weight-bold" style="width: 25%">: </td>
            ...
            <tr>
                <td style="width: 25%">Total Earnings (SAR)</td>
                <td class="font-weight-bold" style="width: 25%" colspan="3">: </td>
            </tr>
        </table>
    </div>
                        ...
                        <table class="table table-hover align-middle">
                            <thead>
                                <tr align="center">
                                    ...
                                    <th class="text-left">Amount Earned (SAR)</th>
                                </tr>
                            </thead>
