            ...
            <div class="d-flex justify-content-end mb-1">
                {{-- <form action="{{ route('users.index') }}" method="GET">
                    <div class="d-flex">
                        ...
                        <button class="btn btn-success" style="border-radius: 0px 50px 50px 0px; height: 36px; margin-top: 10px;"><i class="fas fa-search"></i></button>
                    </div>
                </form> --}}
                <div class="" style="margin-left: 10px">
                    <form action="{{ route('users.index') }}" method="GET">
                        <x-backend.form.search name="search" placeholder="Search" style="width: 220px; margin-top: 10px;" />
                    </form>
                </div>
            </div>
