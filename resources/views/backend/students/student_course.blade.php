                                    ...
                                    <div class="card-body d-flex flex-column">
                                        <div class="course-meta">
                                            <ul class="d-flex" style="padding-left: 17px; margin-bottom: 0px;">
                                                <li>High School</li>
                                                <li style="margin-left:28px">10 Lessons</li>
                                            </ul>
                                        </div>
                                        <h5 class="card-title course-title">Introduction to Physics</h5>
                                        <p class="card-text course-description">Learn the fundamental concepts of physics designed for high school students</p>
                            ...
                            <div class="col-md-3 mb-4">
                                <div class="card course-card h-100">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text course-description">Explore the basic principles of chemistry for high school students.</p>
                                        <a href="{{ route('student.course.details') }}" class="btn view-course-btn mt-auto">View Course</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-4">
                                <div class="card course-card h-100">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text course-description">Discover the living world with foundational biology concepts.</p>
                                        <a href="{{ route('student.course.details') }}" class="btn view-course-btn mt-auto">View Course</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-4">
                                <div class="card course-card h-100">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text course-description">Master the basics of algebra with interactive lessons.</p>
                                        <a href="{{ route('student.course.details') }}" class="btn view-course-btn mt-auto">View Course</a>
                                    </div>
                                </div>
                            </div>
                             <div class="col-md-3 mb-4">
                                <div class="card course-card h-100">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text course-description">An introduction to shapes, angles, and spatial reasoning.</p>
                                        <a href="{{ route('student.course.details') }}" class="btn view-course-btn mt-auto">View Course</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-4">
                                <div class="card course-card h-100">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text course-description">Journey through significant historical events and civilizations.</p>
                                        <a href="{{ route('student.course.details') }}" class="btn view-course-btn mt-auto">View Course</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-4">
                                <div class="card course-card h-100">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text course-description">Explore classic and contemporary works of English literature.</p>
                                        <a href="{{ route('student.course.details') }}" class="btn view-course-btn mt-auto">View Course</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-4">
                                <div class="card course-card h-100">
                                    ...
                                    <div class="card-body d-flex flex-column">
                                        ...
                                        <p class="card-text course-description">An introduction to computational thinking and programming.</p>
                                        <a href="{{ route('student.course.details') }}" class="btn view-course-btn mt-auto">View Course</a>
                                    </div>
                                </div>
                            </div>
