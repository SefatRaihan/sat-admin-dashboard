...
<form>
    ...
    <div class="form-section m-4">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="discount_code" id="discountCode" placeholder="E.g., EID10">
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="discountAmount">Discount Amount</label>
                    <input type="text" class="form-control" name="discount_amount" id="discountAmount" placeholder="E.g., 10">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="maximum_no_of_user" id="maximumNoOfUser" placeholder="E.g., 200">
                </div>
            </div>
            <div class="col-md-6">
                <div class="form-group">
