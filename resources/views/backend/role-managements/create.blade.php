        ...
        <div class="card-body">
            <form action="">
                ...
                <div class="d-flex justify-content-between mt-3">
                    ...
                    <div>
                        <input type="checkbox" class="all-checkbox" checked>  <span style="color: #121926; font-size:16px">All Permissions</span>
                    </div>
                </div>
                ...
                <div class="row mt-2">
                    <div class="col-md-6">
                        <div class="card" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
                            <div class="card-header" style="background-color: #EAECF0">
                                <input type="checkbox" class="checkbox" checked>  <span style="color: #121926; font-size:16px">General Setting</span>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="card" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;">
                            <div class="card-header" style="background-color: #EAECF0">
                                <input type="checkbox" class="checkbox">  <span style="color: #121926; font-size:16px">Notification</span>
                            </div>
                            <div class="card-body pt-3 table-responsive" style="height:300px">
