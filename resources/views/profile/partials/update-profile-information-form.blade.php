        ...
        <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
            ...
            <div class="d-flex">
                ...
                <div class="ml-2">
                    ...
                    <div class="d-flex">
                        <button type="button" class="btn btn-sm filter-submit-btn" style="background-color:#691D5E ;border-radius: 8px; color:#fff; width:50%">Upload</button>
                        <button type="button" class="btn btn-sm btn-outline-dark ml-2 reset-filter" style="border: 1px solid #D0D5DD; border-radius: 8px; width:50%">Remove</button>
                    </div>
                </div>
            </div>
        </form>
