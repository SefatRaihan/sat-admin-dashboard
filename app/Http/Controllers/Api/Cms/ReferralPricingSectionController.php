...
use App\Models\ReferralPricingSection;
use Illuminate\Http\Request;
use Illuminate\Support\Facades\DB;
use App\Http\Controllers\Controller;

class ReferralPricingSectionController extends Controller
{
    public function index()
    {
        return ReferralPricingSection::with('items')->latest()->get();
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::transaction(function () use ($validated, $items, &$section) {
            $section = ReferralPricingSection::first();

            if ($section) {
                $section->update($validated);
                $section->items()->delete();
            } else {
                $section = ReferralPricingSection::create($validated);
            }
        ...
        return response()->json([
            'message' => 'Referral pricing section saved successfully',
