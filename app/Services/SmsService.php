...
class SmsService
{
    ...
    {
        $this->baseUrl = config('services.jawalysms.base_url');
        $this->appId = config('services.jawalysms.app_id');
        $this->appSecret = config('services.jawalysms.app_secret');
    }
