...
class DrillExamAttempt extends Model
{
    use HasFactory, SoftDeletes;

    protected $table = 'drill_exam_attempts';
    ...
    public function drillExamAttemptQuestions()
    {
        return $this->hasMany(DrillExamAttemptQuestion::class, 'attempt_id');
    }
